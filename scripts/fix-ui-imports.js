...
// Create lib/utils.ts for the cn utility function
...
// Define templates for UI components
...
// Components to check and create if missing
const requiredComponents = ['alert', 'button', 'card', 'table'];

// Check each component and create it if missing
requiredComponents.forEach(componentName => {
  const componentExists = ensureComponent(componentName, componentTemplates[componentName]);
  if (!componentExists) {
    console.log(`Created missing component: ${componentName}.tsx`);
  } else {
    console.log(`Component ${componentName}.tsx already exists.`);
  }
});
